...
const BOOK_COLORS = [
  ...
  'rgba(204,213,174,0.78)',
  'rgba(237,201,175,0.50)',
  'rgba(237,201,175,0.80)',
  'rgba(212,163,115,0.58)',
];
...
const BOOK_SPINE_COLORS = [
  ...
  'rgba(204,213,174,0.85)',
  'rgba(204,213,174,0.92)',
  'rgba(237,201,175,0.82)',
  'rgba(237,201,175,0.92)',
          ...
          <div className="flex items-end justify-between gap-4">
            ...
            {books.length > 0 && (
              <Button
                ...
                type="button"
                aria-label="Create new memory book"
