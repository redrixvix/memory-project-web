...
export default function LoginError({
  ...
  return (
    <div
      ...
      aria-labelledby="login-error-heading"
    >
      <div className="text-center max-w-sm">
        ...
        <h2 id="login-error-heading" className="text-xl font-medium mb-3" style={{ color: 'var(--charcoal)' }}>
          Something went wrong
        </h2>
        <p id="login-error-message" className="text-sm mb-8" style={{ color: 'var(--muted-foreground)' }} role="alert" aria-live="polite">
          We couldn&apos;t load the login page right now. This has been logged and we&apos;ll look into it.
        </p>
