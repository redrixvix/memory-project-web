  ...
  return (
    ...
    >
      <div className="text-center max-w-sm">
        ...
        <h2 id="invite-error-heading" className="text-xl font-medium mb-3" style={{ color: 'var(--charcoal)' }}>
          Something went wrong
        </h2>
        <p className="text-sm mb-8" style={{ color: '#6A6A5A' }} role="alert" aria-live="polite">
          We couldn&apos;t load the invite page right now. This has been logged and we&apos;ll look into it.
        </p>
