                ...
                {showPasswordForm && (
                  <div className="mt-4 p-4 rounded-xl space-y-3" style={{ backgroundColor: 'rgba(212,163,115,0.06)', border: '1px solid rgba(212,163,115,0.12)' }}>
                    ...
                    <div>
                      ...
                      />
                        <button type="button" onClick={() => setShowCurrentPassword(p => !p)} aria-label={showCurrentPassword ? 'Hide current password' : 'Show current password'} className="absolute right-1 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center rounded-full hover:opacity-60 transition-opacity cursor-pointer" style={{ color: 'rgba(212,163,115,0.65)', outline: 'none' }} onFocus={e => { e.currentTarget.style.boxShadow = '0 0 0 3px rgba(212,163,115,0.45)'; e.currentTarget.style.outline = 'none'; }} onBlur={e => { e.currentTarget.style.boxShadow = 'none'; }}>
                          {showCurrentPassword ? (
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <Input type={showNewPassword ? 'text' : 'password'} value={newPassword} onChange={e => setNewPassword(e.target.value)} placeholder="New password" className="h-9 rounded-lg text-sm pr-8" aria-invalid={!!passwordError} aria-describedby="password-error" style={passwordError ? { borderColor: '#C0392B', backgroundColor: '#FDFCF5', boxShadow: '0 0 0 3px rgba(192,57,43,0.12)' } : { borderColor: 'rgba(212,163,115,0.55)', backgroundColor: '#FDFCF5' }} onFocus={e => { e.currentTarget.style.borderColor = 'var(--bronze)'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(212,163,115,0.18)'; }} onBlur={e => { e.currentTarget.style.borderColor = passwordError ? '#C0392B' : 'rgba(212,163,115,0.55)'; e.currentTarget.style.boxShadow = passwordError ? '0 0 0 3px rgba(192,57,43,0.12)' : 'none'; }} />
                        <button type="button" onClick={() => setShowNewPassword(p => !p)} aria-label={showNewPassword ? 'Hide new password' : 'Show new password'} className="absolute right-1 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center rounded-full hover:opacity-60 transition-opacity cursor-pointer" style={{ color: 'rgba(212,163,115,0.65)', outline: 'none' }} onFocus={e => { e.currentTarget.style.boxShadow = '0 0 0 3px rgba(212,163,115,0.45)'; e.currentTarget.style.outline = 'none'; }} onBlur={e => { e.currentTarget.style.boxShadow = 'none'; }}>
                          {showNewPassword ? (
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                          ) : (
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <Input type={showConfirmPassword ? 'text' : 'password'} value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} placeholder="Confirm new password" className="h-9 rounded-lg text-sm pr-8" aria-invalid={!!passwordError} aria-describedby="password-error" style={passwordError ? { borderColor: '#C0392B', backgroundColor: '#FDFCF5', boxShadow: '0 0 0 3px rgba(192,57,43,0.12)' } : { borderColor: 'rgba(212,163,115,0.55)', backgroundColor: '#FDFCF5' }} onFocus={e => { e.currentTarget.style.borderColor = 'var(--bronze)'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(212,163,115,0.18)'; }} onBlur={e => { e.currentTarget.style.borderColor = passwordError ? '#C0392B' : 'rgba(212,163,115,0.55)'; e.currentTarget.style.boxShadow = passwordError ? '0 0 0 3px rgba(192,57,43,0.12)' : 'none'; }} />
                        <button type="button" onClick={() => setShowConfirmPassword(p => !p)} aria-label={showConfirmPassword ? 'Hide confirm password' : 'Show confirm password'} className="absolute right-1 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center rounded-full hover:opacity-60 transition-opacity cursor-pointer" style={{ color: 'rgba(212,163,115,0.65)', outline: 'none' }} onFocus={e => { e.currentTarget.style.boxShadow = '0 0 0 3px rgba(212,163,115,0.45)'; e.currentTarget.style.outline = 'none'; }} onBlur={e => { e.currentTarget.style.boxShadow = 'none'; }}>
                          {showConfirmPassword ? (
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                          ) : (
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
