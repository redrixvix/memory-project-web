...
const OUT = 'screens/ui-deep-' + new Date().toISOString().slice(0, 19).replace(/:/g, '-');
...
test('deep UI exploration', async ({ page }) => {
  // ── LOGIN ─────────────────────────────────────────────────────────
  await login(page);
  ...
  // ── BOOK DETAIL ───────────────────────────────────────────────────
  // Navigate directly to first book
  ...
  // ── BOOK EDIT ─────────────────────────────────────────────────────
  if (bookHref) {
    const editUrl = BASE + bookHref + '/edit';
